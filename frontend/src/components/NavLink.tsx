    ...
    return (
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            variant="ghost"
            className="text-primary-foreground hover:bg-primary-hover whitespace-nowrap px-4 py-6 rounded-none border-b-2 border-transparent hover:border-primary-foreground/50 transition-all"
          >
            {label}
