  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEO
        ...
        nextUrl={nextUrl}
        jsonLd={[
          collectionPageSchema("Thư viện ảnh", "Album ảnh hoạt động của Trường THPT Lương Thúc Kỳ", "/chuyen-muc/anh"),
          breadcrumbSchema([{ label: "Thư viện ảnh", href: "/chuyen-muc/anh" }]),
        ]}
      />
      <Header />
      <Navigation />
